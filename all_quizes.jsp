...
<body>
   <!-- Header section -->
	...
	<!-- Page info -->
	<div class="page-info-section set-bg" data-setbg="img/page-bg/1.jpg"  style="height: 250px !important;">
		<div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="asset-inner col-lg-12 col-md-9 col-sm-6 col-xs-3">
                                <table >
       ...
       catch(Exception e2)
       {
        ...
        out.println("<script>window.location.href='login.jsp'</script>");
                                 ...
                                 try{
                                  ...
                                  rs = st.executeQuery("select name, subject, topic, submit_date from quizinfo");
                                  int count=1;
