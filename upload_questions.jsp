...
<!-- <h1 style="margin-top:20px" align="center">Upload Questions</h1>
 --><!-- multistep form -->
<form id="msform" name="form1" method="post" action="quiz_uploaded.jsp" style="margin-top: 300px;">
...
<!-- progressbar -->
<ul id="progressbar">
	<li class="active" style="color: black !important;">Quiz Name</li>
<li style="color: black !important;">Question 1</li>
<li style="color: black !important;">Question 2</li>
<li style="color: black !important;">Question 3</li>
<li style="color: black !important;">Question 4</li>
<li style="color: black !important;">Question 5</li>
</ul>
<!-- QuizName -->
<fieldset>
